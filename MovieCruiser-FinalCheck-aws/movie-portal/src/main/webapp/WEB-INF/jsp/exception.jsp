...
<body>
	<div>
		...
		<nav class="navbar navbar-expand-sm navbar-dark">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="navbar-brand" href="/movie-list"> <em
		...
		<br>
		<div class="container">
			<div class="alert alert-danger">Favorite List is Empty! Go to movie List and add movies into favorites</div>
		</div>
		<br>
		<!-- Footer -->
