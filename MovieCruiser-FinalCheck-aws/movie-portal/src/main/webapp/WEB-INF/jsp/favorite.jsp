...
<body>
	<div>
		...
		<nav class="navbar navbar-expand-sm navbar-dark">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="/movie-list" class="navbar-brand nav-link-white">
		...
		<div class="container-fluid">
			<div class="container">
				<br>
				<h4 class="row-bold">Favorite Movies</h4>
				<br>
				<div class="row row-bold" id="main">
				...
				<c:forEach items="${inf}" var="temp">
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2">
							<a href="deleteItem?id=${temp.id}" class="btn btn-danger">Detele</a>
						</div>
					</div>
					<!-- row -->
					<div class="row">
